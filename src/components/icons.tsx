...
export function EyeOffIcon({ className = "h-4 w-4" }: { className?: string }) {
  return (
    ...
    >
      ...
      <path d="M6.61 6.61C3.06 8.6 2 12 2 12s3 7 10 7a9.7 9.7 0 0 0 5.39-1.61" />
      <path d="m2 2 20 20" />
    </svg>
  );
}

export function JerseyIcon({ className = "h-10 w-10" }: { className?: string }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 48 48"
      ...
      aria-hidden="true"
    >
      <path d="M16.5 6 8 12.2V21l7.5-2.4h2.2V41h20.6V18.6H38L45.5 21v-8.8L37 6h-3.4c-1.2 3.2-9 3.2-10.2 0H16.5Z" />
    </svg>
  );
}
